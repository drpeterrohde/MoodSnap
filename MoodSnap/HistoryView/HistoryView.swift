        ...
        .searchable(
                ...
                suggestions: {
                    Button(action: {
                        ...
                        Label("Search all", systemImage: "magnifyingglass").font(.subheadline)
                    }
                    Button(action: {
                        filter = .mood
                        searchText = ""
                        ...
                        Label("Search MoodSnaps", systemImage: "brain.head.profile").font(.subheadline)
                    }
                    Button(action: {
                        filter = .event
                        searchText = ""
                        ...
                        Label("Search events", systemImage: "star.fill").font(.subheadline)
                    }
                    Button(action: {
                        filter = .note
                        searchText = ""
                        ...
                        Label("Search notes", systemImage: "note.text").font(.subheadline)
                    }
                    Button(action: {
                        filter = .note
                        searchText = ""
                        ...
                        Label("Search media", systemImage: "photo.on.rectangle.angled").font(.subheadline)
                    }
                })
