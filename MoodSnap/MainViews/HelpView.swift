...
//                    Label("Help", systemImage: "questionmark.circle").font(.subheadline)
            ...
            GroupBox(label: Label("Statistics", systemImage: "waveform.path.ecg.rectangle").foregroundColor(themes[data.settings.theme].iconColor)) {
                ...
                Group {
                    Divider()
                    VStack(alignment: .leading) {
                        Label("Influences", systemImage: "eye.circle").foregroundColor(themes[data.settings.theme].iconColor)
                        Spacer()
                ...
                Group {
                    Divider()
                    VStack(alignment: .leading) {
                        Label("Butterfly average", systemImage: "waveform.path.ecg.rectangle").foregroundColor(themes[data.settings.theme].iconColor)
                        Spacer()
                        Text(.init(statistics_butterfly_average_string_1)).font(.subheadline)
                        Image("butterfly_average")
                            .resizable()
                            .aspectRatio(contentMode: .fit)
